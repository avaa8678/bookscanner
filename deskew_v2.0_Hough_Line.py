...
def save_result(image, original_path):
    """
    Save the result image in a "../Bookscanner/bookscanner/results" folder using the same file name as the original.
    """
    filename = os.path.basename(original_path)
    results_folder = os.path.join("..", "Bookscanner", "bookscanner", "results")
...
def main():
    ...
    save_result(sharpened, image_path)
    
    # Display the final result
    display_image('Sharpened Corrected Image', sharpened, p_width, p_height)
